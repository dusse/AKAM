...
private:
    ...
    std::complex<double> callPyFloatFunctionWith4args( PyObject*, const std::string,
...
public:
    ...
    //laser envelope
    double potentialThreshold4Interaction = 1e-2;
    double criticalDensity = 100.;

    int useIonization = 0;
    int useEIcollision = 0;
    double eiCollFreq = 0.0;
    //MPI staff
    ...
    std::complex<double> getLaserBeamEnvelopeProfile(double,double,double,double);
