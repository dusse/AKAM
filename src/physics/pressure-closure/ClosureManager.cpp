...
void ClosureManager::setAlphas(int idxG2, int comp, double val){
     alphas[6*idxG2+comp] = val;
}

void ClosureManager::addAlphas(int idxG2, int comp, double val){
     alphas[6*idxG2+comp] += val;
}
...
void ClosureManager::initialize(){
    ...
    alphas = new double[nG2*6*sizeof(double)];
    ...
    for( ijkG2 = 0; ijkG2 < nG2; ijkG2++ ){
        for( h = 0; h < 6; h++ ){
            ...
            driverNext[6*ijkG2+h] = 0.0;
            alphas[6*ijkG2+h] = 0.0;
        }
    }
            ...
            for( k = 1; k < zRes+1; k++ ){
                ...
                for( m = 0; m < numOfSubStep; m++ ){
                    ...
                    for( h = 0; h < 6; h++ ){
                        ...
                        pSub[h] += alphas[ijkG2*6+h] / numOfSubStep;
                    }
                }
                ...
                if( trP < 0.0 || pSub[0] < 0 || pSub[3] < 0 || pSub[5] < 0 ){
                   ...
                   +"\n   alphas[0] = "+to_string(alphas[ijkG2*6+0])
                   +"\n   alphas[1] = "+to_string(alphas[ijkG2*6+1])
                   +"\n   alphas[2] = "+to_string(alphas[ijkG2*6+2])
                   +"\n   alphas[3] = "+to_string(alphas[ijkG2*6+3])
                   +"\n   alphas[4] = "+to_string(alphas[ijkG2*6+4])
                   +"\n   alphas[5] = "+to_string(alphas[ijkG2*6+5])
                   +"\n  ijkG2 = "+to_string(ijkG2)
