...
#include "../physics/collisions/ElectronIonCollisionManager.hpp"
#include "../physics/ionization/IonizationManager.hpp"
...
private:
    ...
    std::shared_ptr<ElectronIonCollisionManager> eicollideMng;
    std::shared_ptr<IonizationManager> ionizeMng;
...
public:
    Solver(std::shared_ptr<Loader>, std::shared_ptr<GridManager>,
                 ...
                 std::shared_ptr<ElectronIonCollisionManager>,
                 std::shared_ptr<IonizationManager>);
